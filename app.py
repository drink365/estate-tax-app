...
with brand_col1:
    try:
        st.image("assets/logo2.png", caption=None, use_container_width=True)
    except Exception:
        pass
with brand_col2:
...
page = st.sidebar.radio("請選擇", ["🏛️ 遺產稅試算（Estate Tax）", "🎁 保單贈與規劃（CVGift）"], index=0, label_visibility="collapsed")
