# modules/wrapped_cvgift.py — 模組二：保單贈與規劃
import pandas as pd
...
def run_cvgift():
    ...
    st.number_input("年繳保費（元）", min_value=0, max_value=MAX_ANNUAL, step=100_000, format="%d", key="y1_prem", on_change=_on_prem_change)
